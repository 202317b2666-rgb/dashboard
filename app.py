...
# For testing, create a dummy numeric column for color
hex_df['TestValue'] = range(len(hex_df))

# Dummy line chart data for testing
...
# 3️⃣ Create choropleth map for testing
fig = px.choropleth(
    hex_df,
    geojson=geojson,
    locations='iso_alpha',
    color='TestValue',  # numeric column for testing
    hover_name='Country',
...
if selected_points:
    ...
    # 5️⃣ Show modal popup with indicators + line charts
